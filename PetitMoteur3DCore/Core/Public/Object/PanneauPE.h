...
namespace PM3D
{
    ...
    public:
        ...
        void SetTexturesShaderVariables(const std::string& name, const std::vector<std::wstring>& filenames);
    ...
    private:
        ...
        HRESULT SetShaderVar(const std::string& name, const int& i) const;
