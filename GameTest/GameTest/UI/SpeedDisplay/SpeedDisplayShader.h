...
namespace PM3D_API
{
    class SpeedDisplayShader final : public Shader
    {
    public:
        explicit SpeedDisplayShader(const std::wstring& fileName);
        ~SpeedDisplayShader() override;
        ...
        struct SpeedDisplayShaderParameters
        {
            DirectX::XMMATRIX matWorldViewProj;
