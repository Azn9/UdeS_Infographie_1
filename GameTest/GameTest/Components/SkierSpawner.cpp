...
)
{
    ...
    rskiRigidbodyPtr->getRigidDynamic()->setRigidDynamicLockFlags(
    ...
    skierRigidbodyPtr->getRigidDynamic()->setRigidDynamicLockFlags(
        physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_Z | physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_X |
        physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_Y);
...
void SkierSpawner::SkierWave1()
{
    for (int i = 0; i != 3; ++i)
    {
        AddSkier(DirectX::XMFLOAT3(-10.f + i * 10.f, -91.f, -60.f), _current_id, 1);
        _current_id++;
    }
}
...
void SkierSpawner::SkierWave2()
{
    for (int i = 0; i != 3; ++i)
    {
        AddSkier(DirectX::XMFLOAT3(30.f + i * 6.f, -235.f, -360.f), _current_id, 2);
        _current_id++;
    }
}
