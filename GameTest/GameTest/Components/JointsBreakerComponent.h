    ...
    void PhysicsUpdate() override
    {
        if (_collisionHappend)
        {
            ...
            if (skieurShape->getSimulationFilterData().word1 == _id)
            {
                ...
                auto nbWritten1 = parentObject->GetComponent<PM3D_API::Rigidbody>()->GetActor()->getConstraints(
                    &joint1, 1, 0);
                if (nbWritten1 != 0)
                {
                    ...
                    static_cast<physx::PxRigidDynamic*>(skier)->setRigidDynamicLockFlag(
                        physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_X, false);
                    static_cast<physx::PxRigidDynamic*>(skier)->setRigidDynamicLockFlag(
                        physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_Y, false);
                    static_cast<physx::PxRigidDynamic*>(skier)->setRigidDynamicLockFlag(
                        physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_Z, false);
                    static_cast<physx::PxRigidDynamic*>(skier)->setAngularVelocity(physx::PxVec3(1.f, 2.f, 3.f));

                    parentObject->GetComponent<PM3D_API::Rigidbody>()->getRigidDynamic()->setLinearVelocity(
                        physx::PxVec3(0.f, 15.f, -5.f));
