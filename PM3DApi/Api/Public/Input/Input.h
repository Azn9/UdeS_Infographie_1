...
public:
    ...
    void addKeyPressedListener(const std::function<void(KeyCode&)>& listener)
    {
        keyPressedListeners.push_back(listener);
    }

    void addKeyReleasedListener(const std::function<void(KeyCode&)>& listener)
    {
    ...
    void SetMouseLeftPressed(bool cond);
    void SetMouseRightPressed(bool cond);
    ...
    static void AddKeyPressedListener(const std::function<void(KeyCode&)>& listener)
    {
        GetInstance().addKeyPressedListener(listener);
    }

    static void AddKeyReleasedListener(const std::function<void(KeyCode&)>& listener)
    {
        GetInstance().addKeyReleasedListener(listener);
    }

    template <class F>
    static auto AddKeyPressedListener(
        F&& listener) -> decltype(AddKeyPressedListener(std::function(std::forward<F>(listener))))
    {
