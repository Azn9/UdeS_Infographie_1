...
PM3D_API::SpriteShader::SpriteShader(const std::wstring& fileName) : Shader(), vertexBuffer(nullptr), indexBuffer(nullptr)
{
...
void PM3D_API::SpriteShader::ApplyMaterialParameters(void* shaderParameters,
