...
void PM3D_API::Rigidbody::DrawDebugInfo() const
{
    ...
    else
    {
        ...
        ImGui::Text("X: %f", dynamic->getLinearVelocity().x);
        ImGui::SameLine(200.0f);
        ImGui::Text("Y: %f", dynamic->getLinearVelocity().y);
        ImGui::SameLine(300.0f);
        ImGui::Text("Z: %f", dynamic->getLinearVelocity().z);

        ImGui::Text("Angular vel.");
        ImGui::SameLine(100.0f);
        ImGui::Text("X: %f", dynamic->getAngularVelocity().x);
        ImGui::SameLine(200.0f);
        ImGui::Text("Y: %f", dynamic->getAngularVelocity().y);
        ImGui::SameLine(300.0f);
        ImGui::Text("Z: %f", dynamic->getAngularVelocity().z);
    }
}
