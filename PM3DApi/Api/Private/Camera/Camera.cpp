...
void PM3D_API::Camera::DrawDebugInfo() const
{
    ...
    ImGui::SameLine(100);
    ImGui::Text(("x=" + std::to_string(focusPoint[0])).c_str());
    ImGui::SameLine(200);
    ImGui::Text(("y=" + std::to_string(focusPoint[1])).c_str());
    ImGui::SameLine(300);
    ImGui::Text(("z=" + std::to_string(focusPoint[2])).c_str());
    ...
    ImGui::SameLine(100);
    ImGui::Text(("x=" + std::to_string(upDirection.m128_f32[0])).c_str());
    ImGui::SameLine(200);
    ImGui::Text(("y=" + std::to_string(upDirection.m128_f32[1])).c_str());
    ImGui::SameLine(300);
    ImGui::Text(("z=" + std::to_string(upDirection.m128_f32[2])).c_str());
    ...
    ImGui::Text("Type");
    ImGui::SameLine(100);
    ImGui::Text(cameraType == PERSPECTIVE ? "Perspective" : "Orthographic");

    if (cameraType == PERSPECTIVE)
    {
        ImGui::Text("Field of view");
        ImGui::SameLine(100);
        ImGui::Text(std::to_string(fieldOfView).c_str());
    }

    ImGui::Text("Near distance");
    ImGui::SameLine(100);
    ImGui::Text(std::to_string(nearDist).c_str());

    ImGui::Text("Far distance");
    ImGui::SameLine(100);
    ImGui::Text(std::to_string(farDist).c_str());
}
